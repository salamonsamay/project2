...
public class Polynom implements Polynom_able{
    ...
    public Polynom_able derivative() {
        ...
        for(int i=0;i<this.monoms.size();i++){
            dePolynom_able.add(new Monom(monoms.elementAt(i).get_coefficient()*monoms.elementAt(i).get_power(),monoms.elementAt(i).get_power()-1));
        }
